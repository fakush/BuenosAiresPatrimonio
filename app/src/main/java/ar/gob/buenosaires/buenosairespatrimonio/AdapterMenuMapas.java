...
public class AdapterMenuMapas extends BaseAdapter {
    ...
    public AdapterMenuMapas(Activity LocalActivity, ArrayList MyArrayListOfObjects, Resources LocalResources) {
    ...
    public class MainClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            MenuMapas sct = (MenuMapas) activity;
