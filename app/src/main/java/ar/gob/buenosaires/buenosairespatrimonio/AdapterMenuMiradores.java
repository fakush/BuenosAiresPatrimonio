...
public class AdapterMenuMiradores extends BaseAdapter {
    ...
    public AdapterMenuMiradores(Activity LocalActivity, ArrayList MyArrayListOfObjects, Resources LocalResources) {
    ...
    public class MainClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            MenuMiradores sct = (MenuMiradores) activity;
